...
| `src/components/Hero/Hero.tsx:179,186`（打字機游標與 `//` 註解斜線色，非「Available for opportunities」狀態燈——該綠點是 `var(--accent-green)`，屬 INFORMATIONAL 保留不動） | `rgba(41,151,255,0.45)` / `var(--accent-blue)` | `rgba(255,229,0,0.45)` / `var(--accent-signature)` |
