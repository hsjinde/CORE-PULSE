...
const projects: Project[] = [
  {
    ...
    solution: '將 SPARQL 的 RDF 三元組視為標籤，以 Binary Relevance 與 Classifier Chains 兩種多標籤轉換方法搭配 RNN 分類器（GloVe / BERT / POS 詞嵌入），再提出 Ensemble BR 以集成學習納入標籤間的關聯。',
    result: 'Ensemble BR 在 QALD-7/8/9 與 LC-QuAD 四個基準達到 82.6% / 93.94% / 76.82% / 76.1% 準確率，其中 LC-QuAD 較前期方法提升逾 10%；End-to-End 的 Precision / Recall / F-measure 優於 QAMP、DTQA 等系統。',
