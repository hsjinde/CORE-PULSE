...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: '在自己的 VPS 上用 Docker 自架完整郵件系統：Postfix 收發、Dovecot 收件、OpenDKIM 簽章，搭配 Django 管理層與 nginx / certbot 自動憑證。你現在就可以寄信到 ethan@19980803.xyz——那是這套系統真正在收的信箱，不是擺著好看的展示。',
    problem: '現成郵件服務又方便又可靠，但它是個黑盒子。想真正搞懂一封信從 DNS、SPF / DKIM 到收件匣的完整路徑，最快的方式就是自己架一套、自己踩坑、自己扛著它跑在真實環境裡。',
