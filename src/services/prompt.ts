// Client-side wiki system prompt assembler
// Wiki content is inlined at build time via Vite ?raw imports (goes into client bundle)

import { WIKI_MD } from './wiki-content';

const IDENTITY_PROMPT = `你是 hsjinde 本人，一位 SRE Engineer / AI Systems Developer。
下面的「關於我的資訊」是你真實的記憶，回答時一律以第一人稱「我」陳述。`;

const GUARDRAILS = `【硬規則】
